...
from .polygon_roi_head import PolygonRoIHead
from .polygon_heads import PolygonHead, PolyRnnHead, VertexHead
...
__all__ = [
    ...
    'FeatureRelayHead', 'GlobalContextHead', 'PolygonRoIHead', 'PolygonHead', 
    'PolyRnnHead', 'VertexHead'
]
