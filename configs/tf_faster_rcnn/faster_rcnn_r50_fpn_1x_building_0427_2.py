...
data = dict(
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'ms/train/train.json',
        img_prefix=data_root + 'ms/train/JPEGImages/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'ms/val/val.json',
        img_prefix=data_root + 'ms/val/JPEGImages/',
